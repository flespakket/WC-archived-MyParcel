...
class WC_NLPostcode_Fields {
	...
	public function nl_checkout_fields( $fields, $country, $form ) {
		...
		$fields[$form.'_street_name'] = array(
			'label'			=> __( 'Street name', 'wcflespakket' ),
			'placeholder'	=> __( 'Street name', 'wcflespakket' ),
